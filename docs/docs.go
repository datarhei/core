    ...
    "paths": {
        ...
        "/api/v3/auth/totp": {
            "get": {
                ...
                "operationId": "totp-status",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.TOTPStatus"
                        }
                    }
                }
            },
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "TOTP confirmation code",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.TOTPDisable"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.TOTPEnable"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v3/auth/totp/setup": {
            "post": {
                ...
                "operationId": "totp-setup",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.TOTPSetup"
                        }
                    },
                    "409": {
