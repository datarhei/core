...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v3/cluster/process/{id}/config": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "cluster-3-get-process-config",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Process ID",
        ...
        "/api/v3/cluster/process/{id}/report": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "cluster-3-get-process-report",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Process ID",
        ...
        "/api/v3/cluster/process/{id}/state": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "cluster-3-get-process-state",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Process ID",
